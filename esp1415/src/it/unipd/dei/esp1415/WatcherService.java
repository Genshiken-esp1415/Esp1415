...
public class WatcherService extends Service implements SensorEventListener{
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		// inizializzo startTime con la data di inizio sessione + la durata gi�
		// trascorsa (necessario se � stata messa in pausa la sessione)
		startDate = new Date();
	...
	public void onSensorChanged(SensorEvent event)
	{
		...
		synchronized(this)
		{
			...
			if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER)
			{
				...
				//se il dato in testa alla coda � piu vecchio di un secondo lo scarto
				...
				//calcolo il modulo dell'accelerazione-forza di gravit� per stimare una caduta
	...
	private class ProcessFallTask extends AsyncTask<String, Integer, Long> implements AsyncInterface {
		...
		protected void onPreExecute(){
		 ...
		 protected Long doInBackground(String... params) {
		    ...
		    //ciclo finch� non ottengo una posizione dal gps
